...
variable "bastion_key_pair_path" {
  type        = string
...
variable "bastion_private_ip" {
  type        = string
  description = "Fixed private IP address for the bastion instance, within bastion_subnet_name's CIDR. Leave null for AWS to auto-assign."
  default     = null
}
...
variable "primary_ec2_key_pair_path" {
  type        = string
  description = "Name of the key pair for the EC2 instance"
  default     = null
}

variable "primary_ec2_public_key_secret_name" {
  type        = string
  description = "Path to the public key for the bastion EC2 instance"
  default     = null
}
...
variable "primary_ec2_private_ip" {
  type        = string
  description = "Fixed private IP address for the primary EC2 instance, within primary_ec2_subnet_name's CIDR. Leave null for AWS to auto-assign."
  default     = null
}
...
variable "standby_ec2_key_pair_path" {
  type        = string
  description = "Name of the key pair for the EC2 instance"
  default     = null
}

variable "standby_ec2_public_key_secret_name" {
  type        = string
  description = "Path to the public key for the bastion EC2 instance"
  default     = null
}
...
variable "standby_ec2_private_ip" {
  type        = string
  description = "Fixed private IP address for the standby EC2 instance, within standby_ec2_subnet_name's CIDR. Leave null for AWS to auto-assign."
  default     = null
}
